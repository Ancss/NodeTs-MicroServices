...
* Steps to build and push your image to docker hub
  * `docker build -t <your-dockerhub-username>/ancss-gig .`
  * `docker tag <your-dockerhub-username>/ancss-gig <your-dockerhub-username>/ancss-gig:stable`
  * `docker push <your-dockerhub-username>/ancss-gig:stable`
