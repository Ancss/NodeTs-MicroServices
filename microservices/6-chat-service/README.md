...
* Steps to build and push your image to docker hub
  * `docker build -t <your-dockerhub-username>/ancss-chat .`
  * `docker tag <your-dockerhub-username>/ancss-chat <your-dockerhub-username>/ancss-chat:stable`
  * `docker push <your-dockerhub-username>/ancss-chat:stable`
