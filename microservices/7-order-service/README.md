...
* Once you have your `.npmrc` and before you run `npm install` command, replace all occurrences of `@ancss/ancss-shared` with your own shared library.
* After replacing all occurrences of `@ancss/ancss-shared`, you can then run `npm install` command.
...
* Steps to build and push your image to docker hub
  * `docker build -t <your-dockerhub-username>/ancss-order .`
  * `docker tag <your-dockerhub-username>/ancss-order <your-dockerhub-username>/ancss-order:stable`
  * `docker push <your-dockerhub-username>/ancss-order:stable`
